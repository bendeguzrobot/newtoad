...
export function fetchCompanies(params: FetchCompaniesParams = {}): Promise<CompaniesResponse> {
  const { page = 1, limit = 20, sort = 'seo_score', dir = 'desc', search, industry, company_size, min_score, max_score, mood, style, missing_metadata, has_metadata, missing_screenshot, has_screenshot } = params;
